...
public class DataGeneratorImpl implements DataGenerator {
    ...
    public String generateMyIndexSegmentData(int numOfInteractions) throws JSONException {

        stringBuilder = new StringBuilder(5500 * numOfInteractions);
...
//            JSONObject jsonObj = new JSONObject();
    ...
    public String generateBulkData(int numOfInteractions) throws JSONException {
        ...
        for (int i = 0; i < numOfInteractions; i++) {
            ...
            jo.put("uniqueDeviceId", "");
            jo.put("userGroupIds", new JSONArray());
            jo.put("participantType", "External");
            jo.put("isInitiator", false);
            jo.put("recordings", Arrays.asList(1, 3));
            participants.put(jo);
            ...
            jo = new JSONObject();
            jo.put("Key", "Voice");
            jo.put("Value", "Successful");
            recordingStatus.put(jo);
            //  endregion
